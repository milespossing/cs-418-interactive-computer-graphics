...
import {updateEntityPosition, bounceOffWall} from "./stateIterators.js";
...
const updateEntityVelocity = dt => entity =>
  R.evolve({
    velocity: R.pipe(
      ...
      bounceOffWall([-1, 0, 0], [1, 0, 0], entity, entity.radius, 0.8),
      bounceOffWall([1, 0, 0], [-1, 0, 0], entity, entity.radius, 0.8),
      bounceOffWall([0, 0, 0], [0, 1, 0], entity, entity.radius, 0.8),
      bounceOffWall([0, 2, 0], [0, -1, 0], entity, entity.radius, 0.8),
      bounceOffWall([0, 0, 1], [0, 0, -1], entity, entity.radius, 0.8),
      bounceOffWall([0, 0, -1], [0, 0, 1], entity, entity.radius, 0.8),
    )
  })(entity);
